...
Write-Host "[2/11] Deploying dummy-app to Kubernetes..." -ForegroundColor Yellow
...
Write-Host "[3/11] Starting kubectl port-forward..." -ForegroundColor Yellow
...
Write-Host "[4/11] Waiting for dummy-app health check..." -ForegroundColor Yellow
Start-Sleep -Seconds 5
try {
...
Write-Host "[5/11] Starting Telemetry Collector..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList @(
    "-NoProfile", "-NoExit", "-Command",
...
Write-Host "[6/11] Waiting 10s for telemetry to collect first data..." -ForegroundColor Yellow
Start-Sleep -Seconds 10

# ─── STEP 7: Start orchestrator ──────────────────────────────────────────────
Write-Host "[7/11] Starting Orchestrator (live mode)..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList @(
    "-NoProfile", "-NoExit", "-Command",
...
# ─── STEP 8: Wait ────────────────────────────────────────────────────────────
Write-Host "[8/11] Waiting 5s for orchestrator initialization..." -ForegroundColor Yellow
Start-Sleep -Seconds 5

# ─── STEP 9: Start dashboard ─────────────────────────────────────────────────
Write-Host "[9/11] Starting Dashboard..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList @(
    "-NoProfile", "-NoExit", "-Command",
...
Write-Host "[10/11] Opening dashboard in browser..." -ForegroundColor Yellow
